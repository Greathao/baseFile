...
//        //添加一个类似导航栏的View
//        UIView *navcView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH_ANIMATIONVIEW, NAV_HEIGHT)];
//        navcView.backgroundColor = UIColorMain;
...
//        [navcView addSubview:leftBtn];
        ...
        RightBtn.titleLabel.font = FourteenFontSize;
        [RightBtn setTitle:@"保存" forState:UIControlStateNormal];
        RightBtn.frame = CGRectMake(SCREEN_WIDTH_ANIMATIONVIEW - 90 , SCREEN_HEIGHT_ANIMATIONVIEW - 40, 80, 34);
...
#pragma mark-----点击关闭按钮
- (void)CloseAnimation:(UIView *)btn
{
    //取到背景黑色View
//    UIView *backView = [[btn superview] superview];
    [self hideAnimationWithView:btn];
